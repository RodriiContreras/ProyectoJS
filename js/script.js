...
function Iniciarsesion(){//Tomo los dos valores principales y los mando a un almacenador aparte tambien, y genero un if para que se asegure que sean iguales los datos del registro y del logueo
...
$("#productoscarrito").append(`<img id="metroredux" src="../imagenes/metro.png">
<h2 id="juego1">${juego1.nombre + juego1.precio * 1.21}</h2>
`);
...
productosJuegos.push(new Juegos(juego4.nombre, juego4.precio ));
console.log(JSON.stringify("Se ha agregado el juego= " + juego4.nombre + " al precio de " + juego4.precio + " (Incluyendo IVA)"));

$("#productoscarrito").append(`<img id="carrito_uncharted" src="../imagenes/uncharted4.png">
<h2 id="juego4">${juego4.nombre + juego4.precio}</h2>
`);
...
$(document).ready(function carrito(){
  $("#jquerycarrito").append(`<div id="nombreproducto"><h1>Aqui esta su carrito:</h1></div>
